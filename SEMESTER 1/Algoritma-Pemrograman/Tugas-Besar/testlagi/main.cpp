        ...
        if (pilihan == 1){
                    ...
                    if (pilihan == 1) {
                        ...
                        for (j = 1; j <= n; j++) {
                            ...
                            gotoxy(71, 4);
                            cin >> pasienB[j].nama.namadepan;
                            gotoxy(71, 5);
                            cin >> pasienB[j].nama.namabelakang;
                            gotoxy(71, 6);
                            cin >> pasienB[j].nikB;
                            gotoxy(71, 7);
                            cin >> pasienB[j].umur;
                            gotoxy(71, 9);
                            cin >> pasienB[j].alamat;
                            cout << endl << endl;
                        }
                        system("pause");
                    } else if (pilihan == 3) {
                        ...
                        if (dokter2 == "Gigi") {
                            for (j = 1; j <= n; j++) {
                                cout << "\t \t \t \t \t \t"; cout << "=================================" << endl;
                                cout << "\t \t \t \t \t \t"; cout << "========DATA PASIEN Ke -" << j << "========" << endl;
                                cout << "\t \t \t \t \t \t"; cout << "=================================" << endl << endl;

                                cout << "\t \t \t \t \t \t"; cout << "Nama         : " << pasienB[j].nama.namadepan << " " << pasienB[j].nama.namabelakang << endl;
                                cout << "\t \t \t \t \t \t"; cout << "No Identitas : " << pasienB[j].nikB << endl;
                                cout << "\t \t \t \t \t \t"; cout << "Umur         : " << pasienB[j].umur << endl;
                                cout << "\t \t \t \t \t \t"; cout << "Dokter       : " << dokter2 << endl;
                                cout << "\t \t \t \t \t \t"; cout << "Alamat       : " << pasienB[j].alamat << endl;
                                cout << "\t \t \t \t \t \t"; cout << "---------------------------------" << endl << endl;
                            }
                        } else {
                            gotoxy(40, 4); cout << "+=====================================+" << endl;
                    ...
                    if (pilihan == 1) {
                        ...
                        for (m = 1; m <= n; m++) {
                            ...
                            gotoxy(71, 4);
                            cin >> pasienC[m].nama.namadepan;
                            gotoxy(71, 5);
                            cin >> pasienC[m].nama.namabelakang;
                            gotoxy(71, 6);
                            cin >> pasienC[m].nikC;
                            gotoxy(71, 7);
                            cin >> pasienC[m].umur;
                            gotoxy(71, 9);
                            cin >> pasienC[m].alamat;
                            cout << endl << endl;
                        }
                        system("pause");
                    } else if (pilihan == 3) {
                        ...
                        if (dokter3 == "Mata") {
                            for (m = 1; m <= n; m++) {
                                cout << "\t \t \t \t \t \t"; cout << "=================================" << endl;
                                cout << "\t \t \t \t \t \t"; cout << "========DATA PASIEN Ke -" << m << "========" << endl;
                                cout << "\t \t \t \t \t \t"; cout << "=================================" << endl << endl;

                                cout << "\t \t \t \t \t \t"; cout << "Nama         : " << pasienC[m].nama.namadepan << " " << pasienC[m].nama.namabelakang << endl;
                                cout << "\t \t \t \t \t \t"; cout << "No Identitas : " << pasienC[m].nikC << endl;
                                cout << "\t \t \t \t \t \t"; cout << "Umur         : " << pasienC[m].umur << endl;
                                cout << "\t \t \t \t \t \t"; cout << "Dokter       : " << dokter3 << endl;
                                cout << "\t \t \t \t \t \t"; cout << "Alamat       : " << pasienC[m].alamat << endl;
                                cout << "\t \t \t \t \t \t"; cout << "---------------------------------" << endl << endl;
                            }
                        } else {
                            gotoxy(40, 4); cout << "+=====================================+" << endl;
