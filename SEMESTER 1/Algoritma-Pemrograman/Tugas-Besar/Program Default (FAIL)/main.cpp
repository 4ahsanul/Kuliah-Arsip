...
int main(){
    do{
        ...
        if (pilihan == 1){
                    ...
                    if (pilihan == 1) {
                        ...
                        if (dokter1 == "Umum") {
                            for (i = 1; i <= n; i++) {
                                ...
                                cout << "\t \t \t \t \t \t"; cout << "No Identitas : " << nik << endl;
                ...
                switch (pilihan){
                    case 1:
                        gotoxy(40, 2); cout << "========== PENCARIAN IDENTITAS =========" << endl << endl;
                        gotoxy(40, 4); cout << "Cari berdasarkan No Identitas" << endl;
                        gotoxy(40, 5); cout << "Masukkan No Identitas \t: ";
                        gotoxy(40, 6); cout << "==================================" << endl << endl;
                        gotoxy(40, 10); cout << "==================================" << endl << endl;
                        gotoxy(66, 5); cin >> nikk;
                        if (nikk == nik){
...
//PROGRAM BERAKHIR
//Program Diselesaikan oleh Filfimo Yulfiz Ahsanul Hulqi (19102143), 10 Januari 2020, Jam 8:25 WIB
