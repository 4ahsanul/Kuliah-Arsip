<div class="container-fluid">
	<button class="btn btn-sm btn-success mb-2" data-toggle="modal" data-target="#tambah_barang"> <i class ="fas fa-plus fa-sm"></i>Tambah Barang</button>
