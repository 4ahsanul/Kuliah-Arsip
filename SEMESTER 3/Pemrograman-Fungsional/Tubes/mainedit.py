...
def menu():
    print ("=========================================")
    print ("        DATA BENCANA PUSDALOPS PB        ")
    print ("        BPBD PROVINSI JAWA TENGAH        ")
    print ("=========================================")
...
while option != 0:
    ...
    if option == 1:
        ...
        print("Berikut daerah yang tercatat dalam database : ")
        print()
    ...
    ##Menampilan data dengan group by
        ...
        print("Berikut data bencana dari masing-masing daerah : ")
        print()
    ...
    #Menampilan jumlah kejadian
        ...
        print("Berikut data jumlah kejadian bencana : ")
        print()
    ...
    #Menampilan urutan jumlah kerugian
        ...
        print("Jumlah kerugian terkecil-terbesar : ")
        print()
    ...
    #Menampilan total jumlah kerugian
        ...
        print("Berikut adalah total jumlah kerugian :")
        print()
    ...
    #Menampilkan data daerah dan kerugian
        ...
        #menggabungkan iterable data daerah dan data kerugian
        daerah_kerugian = list(itertools.chain(data_daerah,data_kerugian))
        print("Berikut adalah data daerah dan jumlah kerugian :")
        print()
        #Mengeluarkan Output
        print(daerah_kerugian)
    #Menampilkan daerah dengan jumlah korban diatas 100
    elif option == 7:
        #untuk memfilter fungsi filter awal dengan iterable data daerah
    ...
    #Menampilkan rerata dari kerugian
        ...
        #fungsi rataan yang mengambil data dari data_kerugian
        rataan = rataan(data_kerugian)
        #Mengeluarkan Output
        #%0.2f adalah untuk menyederhanakan angka dibelakan koma
        print("Rata-Rata Kerugian Prov Jawa Tengah adalah", "%0.2f" % rataan)
        #print("%0.2f" % rataan)
    ...
    #Menampilkan daerah acak
        ...
        print("Berikut didapatkan pasangan daerah acak : ")
        print()
        #Looping sekaligus menampilkan output data
    ...
    #Permutasi data kejadian
        ...
        print("Didapatkan hasil permutasi data sebagai berikut : ")
        print()
        #Looping sekaligus menampilkan output data
    ...
    #Count data Korban
      ...
      print("Data korban bencana adalah :")
      print()
